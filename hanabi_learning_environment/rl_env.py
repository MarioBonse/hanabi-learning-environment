...
class HanabiEnv(py_environment.PyEnvironment):
    ...
    def _reset(self):
        ...
        Returns:
            observation: TimeStep, containing the observation of the current agent along with the
                        illegal moves and three other observation vectors that will not be passed 
                        to the agent (they are use only to run the environment verbosely and 
                        have intelligible output)
        """
    ...
    def _step(self, action):
        ...
        Args:
            action: Follows self._action_spec
